...
const WIKIMEDIA_THUMBNAIL_WIDTHS = [120, 250, 330, 500, 960, 1280, 1920, 3840]

const THUMBNAIL_URL = /^(https:\/\/upload\.wikimedia\.org\/.+\/thumb\/.+)\/\d+px-([^/]+)$/
...
export default function wikimediaLoader({ src, width }) {
