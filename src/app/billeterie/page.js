...
export const metadata = {
  title: "Billetterie",
  description:
    "Réservez vos billets pour Le Métropolitain : tarifs, options et visite guidée.",
...
export default function BilleteriePage() {
  return (
    <Section
      ...
      intro="Choisissez vos billets et vos options : le récapitulatif se met à jour en temps réel."
      className="pt-24"
    >
